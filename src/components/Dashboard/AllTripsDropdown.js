...
export const AllTripsDropdown = ({ updatedTripDetailsSaved, setUpdatedTripDetailsSaved, fetchLists, setActiveTrip, toggleRefreshAllTripsDropdown }) => {
    ...
    }, [updatedTripDetailsSaved, toggleRefreshAllTripsDropdown]);
